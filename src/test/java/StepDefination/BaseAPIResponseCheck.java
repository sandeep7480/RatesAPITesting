/********************************************************************************************************
 ...
 Description: Test cases develop to check Base API response
...
public class BaseAPIResponseCheck {
	private SoftAssertions softAssertions;
	Response response;
	public static Logger log = Logger.getLogger(BaseAPIResponseCheck.class);

	@Given("^Enter below base API enpoint \"([^\"]*)\"$")
	public void OpenBaseAPI(String url) {
	...
	public void baseAPI_sucessResponse_as(int arg1) throws Throwable {
	...
	public void baseAPI_jsonResponseCheck() {
		...
		log.info("Base API Response body is correct");
